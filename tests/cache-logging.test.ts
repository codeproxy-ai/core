  ...
  it('collects cache stats from streaming response', async () => {
    ...
    const mockStream = new ReadableStream<Uint8Array>({
      async start(controller) {
        ...
        controller.enqueue(encoder.encode('data: {"type":"message_start","message":{"usage":{"input_tokens":100,"cache_creation_input_tokens":25,"cache_read_input_tokens":75}}}\n\n'));
        ...
        controller.enqueue(encoder.encode('data: {"type":"message_delta","delta":{},"usage":{"output_tokens":50}}\n\n'));
        // Send message_stop
